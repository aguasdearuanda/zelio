...
ActiveRecord::Schema.define(version: 20_190_218_183_539) do
  ...
  create_table 'attendances_klasses', id: false, force: :cascade do |t|
    ...
    t.index %w[attendance_id klass_id], name: 'index_attendances_klasses_on_attendance_id_and_klass_id'
    t.index %w[klass_id attendance_id], name: 'index_attendances_klasses_on_klass_id_and_attendance_id'
  end

  create_table 'attendances_students', id: false, force: :cascade do |t|
    t.bigint 'attendance_id', null: false
    t.bigint 'student_id', null: false
    t.index %w[attendance_id student_id], name: 'index_attendances_students_on_attendance_id_and_student_id'
    t.index %w[student_id attendance_id], name: 'index_attendances_students_on_student_id_and_attendance_id'
  end
